...
from ai_edge_eval.api import pipeline
...
class EvalPipelineTest(unittest.TestCase):
  ...
  @mock.patch(
      "ai_edge_eval.api.pipeline._load_runner_allowlist"
  )
  @mock.patch("ai_edge_eval.api.pipeline._load_task_allowlist")
  ...
  @mock.patch("ai_edge_eval.api.pipeline._load_task_allowlist")
  @mock.patch("ai_edge_eval.runners.registry.create_runner")
  @mock.patch("ai_edge_eval.frameworks.registry.get_framework")
