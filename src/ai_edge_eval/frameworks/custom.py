...
from ai_edge_eval.api import constants as api_constants
from ai_edge_eval.custom_tasks import base as tasks_base
from ai_edge_eval.custom_tasks import loaders
from ai_edge_eval.custom_tasks import registry as tasks_registry
from ai_edge_eval.frameworks import base
from ai_edge_eval.frameworks import registry
from ai_edge_eval.runners import base as runners_base
from ai_edge_eval.utils import introspection
import httpx
import tqdm
...
class CustomFramework(base.AbstractEvalFramework):
  ...
  def supported_runners(cls) -> list[str]:
    ...
    from ai_edge_eval.runners import registry as runner_registry  # pylint: disable=g-import-not-at-top
